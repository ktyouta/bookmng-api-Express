...
export class BookSearchService {
     ...
     * @returns 
     */
    public parseGoogleBooksAPIsModelItems(googleBooksApiCacheMergedList: GoogleBooksApiCacheModelType[]) {
     ...
     */
    public getBookSearchRepositorys(): BookSearchRepositoryInterface {
